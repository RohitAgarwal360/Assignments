...
public class MacroPass2 {
	...
	public static void main(String[] args) throws Exception {
		...
		while((inputLine = input.readLine()) != null )
		{
			...
			if((addinMDT=searchmacro(tokenLine[0]))!="-1")  //FOUND IN MNT, GO IN
			{
				...
				while((mdtLine = mdt.readLine()) != null )
				{
					...
					if(mdttokenLine[0].equalsIgnoreCase(addinMDT))   //0===0 |5===5
					{
						//System.out.println(mdtLine);
						
						Flag=1;   						//MACRO DEFINITION FOUND IN MDT
						...
						if(mdttokenLine.length>2)  //FOR MEND
						{
